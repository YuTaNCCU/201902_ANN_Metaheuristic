...
class ES:
    ...
    def run(self, weights, max_steps=5, verbose=10):
        ...
        if isinstance(weights, list)  :
            ...
            print('self.WeightsStrucure>>>>>>>>>>>>>>',self.WeightsStrucure)
...
model = Sequential()
model.add(Dense(2, activation='relu', input_shape=(30,)))
#model.add(Dense(4, activation='relu'))
#model.add(Dense(4, activation='relu', name = 'IntermediateLayer'))
